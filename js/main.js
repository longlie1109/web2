...
Validator.isName = function( selector ) {
    return {
        selector: selector,
        test: function(value) {
            var regex =/^[A-Za-zÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚÝàáâãèéêìíòóôõùúýĂăĐđĨĩŨũƠơƯưẠ-ỹ ]{2,}$/g
            // regex.test(value) kiểm tra cái test(value) có phải trả về value là định dạng gmail hay k 
            // nếu có thì true ngc lại flase
            return regex.test(value) ? undefined : 'Trường này phải là chữ a-z A-Z và không chứa số, kí tự đặc biệt'
        }
    }
}
Validator.isNumber = function( selector ) {
    return {
        ...
        test: function(value) {
            ...
            // regex.test(value) kiểm tra cái test(value) có phải trả về value là định dạng gmail hay k 
            // nếu có thì true ngc lại flase
            return regex.test(value) ? undefined : 'Trường này phải là chữ số 0-9'
        }
    }
}
Validator.isPhone = function( selector ) {
    return {
        selector: selector,
        test: function(value) {
            var regex =/^0[7|8|9]\d{8}$/
            // regex.test(value) kiểm tra cái test(value) có phải trả về value là định dạng gmail hay k 
            // nếu có thì true ngc lại flase
            return regex.test(value) ? undefined : 'Trường này phải là số từ 0-9 bắt đầu từ 07,08,09 và đủ 10 kí tự' 
        }
    }
}
